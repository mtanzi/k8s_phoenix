.PHONY: help all port prepare create destroy start stop
...
create:
	kubectl -n production create -f k8s/namespace-prod.yaml

destroy:
	kubectl -n production delete -f k8s/namespace-prod.yaml
